          ...
          <div className="bg-white max-w-4xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 h-full">
              ...
              <div className="bg-[#0266CC] p-10 col-span-1 lg:col-span-2 flex flex-col items-center justify-between">
                ...
                <h2 className="mb-10 font-bold text-2xl text-blue-100 relative before:block before:bg-sky-300 before:content-[''] before:w-20 before:h-1 before:-skew-y-3 before:-bottom-4">
                  Contact Info
                </h2>
              ...
              {/* Form Section */}
              <div className="bg-blue-50 p-14 col-span-1 lg:col-span-4">
                <h2 className="mb-14 font-bold text-4xl text-blue-900 relative before:block before:bg-sky-300 before:content-[''] before:w-20 before:h-1 before:-skew-y-3 before:-bottom-4">
                  Enter Your Details
                </h2>
